...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        "Barbos — трекер прогулок и здоровья вашей собаки.\n\n"
        "Что внутри:\n"
        "🐾 Сегодня — отмечайте прогулки в один тап, следите, кто и когда гулял\n"
        "💊 Медицина — напоминания о клещах, глистогонном и прививках\n"
        "📊 Статистика — кто гулял чаще и сколько прогулок за неделю/месяц/год\n\n"
        "Один участник создаёт профиль собаки и приглашает второго по ссылке — "
        "дальше данные общие для вас двоих.\n\n"
